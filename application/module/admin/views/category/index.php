            ...
            <table class="adminlist" id="modules-mgr">
                ...
                <thead>
                    <tr>
                        ...
                        <!-- <th class="title"><a href="#" onclick="javascipt:submit();">Name</a></th> -->
                    ...
                    <?php
                        if(!empty($this->Items)){
                            ...
                            foreach($this->Items as $key => $value){
                                ...
                                $picturePath    = PATH_UPLOAD . 'category' . DS . '60x90-' . $value['picture'];
                                if(file_exists($picturePath)==true){
                                    $picture    = '<img src="' . URL_UPLOAD . 'category' . DS . '60x90-' . $value['picture'].'">';
                                }else{
                                    $picture    = '<img src="' . URL_UPLOAD . 'category' . DS . '60x90-default.jpg' .'">';
                                }
