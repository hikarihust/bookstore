            ...
            <table class="adminlist" id="modules-mgr">
                ...
                <thead>
                    <tr>
                        ...
                        <th width="4%"><?php echo $lblSaleOff;?></th>
                        ...
                        if(!empty($this->Items)){
                            ...
                            foreach($this->Items as $key => $value){
                                ...
                                if(file_exists($picturePath)==true){
                                    $picture    = '<img width="60" height="90" src="' . URL_UPLOAD . 'book' . DS . '98x150-' . $value['picture'].'">';
                                }else{
                                    $picture    = '<img width="60" height="90" src="' . URL_UPLOAD . 'book' . DS . '98x150-default.jpg' .'">';
                                }
