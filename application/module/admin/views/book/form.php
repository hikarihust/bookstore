<?php 
	include_once (PATH_MODULE . 'admin/views/toolbar.php');
	...
	$inputSaleOff	  = Helper::cmsInput('text', 'form[sale_off]', 'sale_off', @$dataForm['sale_off'], 'inputbox required', 40);
	...
	if(isset($this->arrParam['id']) || $dataForm['id']){	
		...
		$picture	= '<img src="' . URL_UPLOAD . 'book' . DS . '98x150-' . @$dataForm['picture'].'">';
	...
	// Add start
	// $rowPicture2	= Helper::cmsRowForm('', $picture . @$inputPictureHidden);
	// Add end
			...
			<div class="width-100 fltlft">
				<fieldset class="adminform">
					...
					<ul class="adminformlist">
						<?php echo $rowName . $rowPicture . $rowPrice . $rowSaleOff . $rowStatus . $rowSpecial . $rowCategory . $rowOrdering . $rowID . $rowDescription; ?>
					</ul>
					<div class="clr"></div>
					<div>
						<?php echo $inputToken; ?>
