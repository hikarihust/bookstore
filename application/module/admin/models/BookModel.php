...
class BookModel extends Model{
	...
	public function countItem($arrParam, $option = null){
		...
		if(isset($arrParam['filter_special']) && $arrParam['filter_special'] != 'default'){
			if($flagWhere == true){
				...
				$query[]	= "WHERE `special` = '" . $arrParam['filter_special'] . "'";
				$flagWhere	= true;
			}
		}
		...
		if(isset($arrParam['filter_category_id']) && $arrParam['filter_category_id'] != 'default'){
			if($flagWhere == true){
				...
				$query[]	= "WHERE `category_id` = '" . $arrParam['filter_category_id'] . "'";
				$flagWhere	= true;
			}
		}
	...
	public function listItem($arrParam, $option = null){
		...
		$query[]	= "FROM `$this->table` AS `b` LEFT JOIN `" . TBL_CATEGORY . "` AS `c`";
		...
		if(isset($arrParam['filter_state']) && $arrParam['filter_state'] != 'default'){
			if($flagWhere == true){
				...
				$query[]	= "WHERE `b`.`status` = '" . $arrParam['filter_state'] . "'";
				$flagWhere	= true;
			}
		}
		...
		if(isset($arrParam['filter_special']) && $arrParam['filter_special'] != 'default'){
			if($flagWhere == true){
				...
				$query[]	= "WHERE `b`.`special` = '" . $arrParam['filter_special'] . "'";
				$flagWhere	= true;
			}
		}
		...
		if(isset($arrParam['filter_category_id']) && $arrParam['filter_category_id'] != 'default'){
			if($flagWhere == true){
				...
				$query[]	= "WHERE `b`.`category_id` = '" . $arrParam['filter_category_id'] . "'";
				$flagWhere	= true;
			}
		}
