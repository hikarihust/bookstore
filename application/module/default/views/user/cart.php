<!-- TITLE -->
<div class="title">
	<span class="title_icon"><img src="<?php echo $imageURL;?>/bullet1.gif"></span>My cart
</div>
	...
	if(!empty($this->Items)){
		...
		foreach ($this->Items as $key => $value){
			...
			if(file_exists($picturePath)==true){
				$picture	= '<img  width="30" width="45" src="' . URL_UPLOAD . 'book' . DS . '98x150-' . $value['picture'].'">';
			}else{
				$picture	= '<img width="30" width="45" src="' . URL_UPLOAD . 'book' . DS . '98x150-default.jpg' .'">';
			}
...
<a onclick="javascript:submitForm('<?php echo $linkSubimtForm;?>')" href="#" class="checkout">checkout &gt;</a>
</form>
<?php
	}else{
?>
